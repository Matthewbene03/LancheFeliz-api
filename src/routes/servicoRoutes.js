...
import loginRequiredServico from "../middlewares/loginRequired/loginRequiredServico";
...
router.get("/", loginRequired, servicoController.indexServico)

//show -> mostra um usuario -> GET
//Cada usuario vai ter acesso ao seu unico pedido, seja ele cliente ou garçom.
router.get("/:id", loginRequired, servicoController.showServico)

//store/create -> cria um novo usuario -> POST
//Quem cria um serviço vai ser apenas o cliente e o garçom.
router.post("/", loginRequiredServico, servicoController.createServico)
...
router.put("/:id", loginRequiredServico, servicoController.updateServico)
...
router.delete("/:id", loginRequiredServico, servicoController.deleteServico)
